...
var EditForm = function (props) {
    var description = props.description, imgUrl = props.imgUrl, inventory = props.inventory, name = props.name, price = props.price, setUpdatedProduct = props.setUpdatedProduct;
    return (React.createElement(antd_1.Form, { initialValues: { description: description, imgUrl: imgUrl, inventory: inventory, name: name, price: price }, onFieldsChange: function (changedFields, allFields) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            setUpdatedProduct(allFields.reduce(function (previousValue, currentValue) {
